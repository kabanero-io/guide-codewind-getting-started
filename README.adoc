...
. Optional: If you don’t click `Install1 when the notification window first appears, you can access the notification again. Go to the Explorer view, hover the cursor over `Codewind`, and click the switch so that it changes to the `On` position. The window appears. 
